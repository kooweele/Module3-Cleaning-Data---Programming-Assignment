...
run_analysis <- function() {
        ...
        write.table(new_tidy_result,file="tidy_data.txt")
}
...
setWorkingPath <- function() {
        homedir <- "D:/Users/Koo Wee Leong/My Documents/My Education/Coursera/Data Science - John Hopkins/R-Workspace/Cleansing Data - Programming Assignment/UCI HAR Dataset"
        setwd(homedir)       
}
...
setWorkingPath_TrainingData <- function() {
        homedir <- "D:/Users/Koo Wee Leong/My Documents/My Education/Coursera/Data Science - John Hopkins/R-Workspace/Cleansing Data - Programming Assignment/UCI HAR Dataset/train"
        setwd(homedir)       
}
...
setWorkingPath_TestData <- function() {
        homedir <- "D:/Users/Koo Wee Leong/My Documents/My Education/Coursera/Data Science - John Hopkins/R-Workspace/Cleansing Data - Programming Assignment/UCI HAR Dataset/test"
        setwd(homedir)       
}
######################################################################
